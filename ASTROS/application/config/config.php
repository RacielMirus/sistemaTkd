...
|
*/
//$config['base_url'] = 'http://localhost:9094/web2/Proyecto/';
...
//decode se usa para las seciones que usaremos
/*
|--------------------------------------------------------------------------
| Session Variables
|--------------------------------------------------------------------------
...
|	         your session table's PRIMARY KEY when changing this setsessionting.
|
| 'sess_time_to_update'
|
...
$config['sess_cookie_name'] = 'ci_session'; //ci_session
